        ...
        <div className="flex space-x-4 mb-4">
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>
                  Choose the column that uniquely identifies each text entry,
                  such as an ID or name. This will help organize and reference
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>
                  Select the column containing the main text content. This text
                  will be processed and converted into a structured, tabular
