  ...
  return (
    <div className="flex justify-center w-full">
      <div className="flex flex-col w-full max-w-md">
        <Link href="/dataPointExtraction/profiles" className="m-10">
          <Card
        ...
        <Link href="/dataPointExtraction/datasets" className="m-10">
          <Card
            className="hover:bg-gray-100 transform hover:shadow-md"
        ...
        <Link href="/dataPointExtraction/aiAnnotation" className="m-10">
          <Card
            className="hover:bg-gray-100 transform hover:shadow-md"
        ...
        <Link href="/dataPointExtraction/annotation" className="m-10">
          <Card
            className="hover:bg-gray-100 transform hover:shadow-md"
