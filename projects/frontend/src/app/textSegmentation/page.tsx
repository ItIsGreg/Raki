...
const TextSegmentation = () => {
  ...
  const handleDownloadProfile = async () => {
    ...
    try {
      ...
      const profilePoints = await readSegmentationProfilePointsByProfile(
        activeProfile.id
      );
  ...
  return (
    ...
    >
      ...
      <Tabs
        ...
        value={activeTab}
        data-cy="segmentation-tabs"
      >
        <TabsList className="w-full" data-cy="segmentation-tabs-list">
          <TabsTrigger
            value="annotation"
            className="flex-1"
              ...
              <div className="grid grid-cols-2 gap-4 h-[calc(100vh-8rem)]">
                ...
                >
                  <DataPointList
                    ...
                    activeProfilePoints={activeProfilePoints as any}
                  />
                </div>
                <div
                  className="col-span-1 overflow-y-auto"
