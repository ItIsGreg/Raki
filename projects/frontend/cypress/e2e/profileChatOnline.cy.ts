describe('Profile Chat Feature', () => {
  beforeEach(() => {
    ...
    const profileName = 'Test Chat Profile'
    const profileDescription = 'Profile for testing chat functionality'
  ...
  it('should open the profile chat and handle messages', () => {
  ...
  it('should create profile points through chat interaction', () => {
    // Click on the chat button
    cy.get('[data-cy="profile-chat-button"]').click()
  ...
  it('should adopt all profile points when clicking adopt all button', () => {
    // Click on the chat button
    cy.get('[data-cy="profile-chat-button"]').click()
